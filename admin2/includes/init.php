...
if (file_exists('../data/config2.php'))
{
...
require(ROOT_PATH . 'languages/' .$_CFG['lang']. '/admin2/common.php');
require(ROOT_PATH . 'languages/' .$_CFG['lang']. '/admin2/log_action.php');

if (file_exists(ROOT_PATH . 'languages/' . $_CFG['lang'] . '/admin2/' . basename(PHP_SELF)))
{
    include(ROOT_PATH . 'languages/' . $_CFG['lang'] . '/admin2/' . basename(PHP_SELF));
}
