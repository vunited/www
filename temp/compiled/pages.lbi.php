...
?>
    ...
    <?php endif; ?>
    <span class="f_l f6" style="margin-right:10px; font-size:12px"><?php echo $this->_var['lang']['pager_1']; ?><b><?php echo $this->_var['pager']['record_count']; ?></b> <?php echo $this->_var['lang']['pager_2']; ?></span>
</div>
