...
if($act == 'checkout' || $act == 'consignee'){
	...
	if($act == 'consignee')
	{
		...
		if(!$district_list){
			$district_list = get_regions(3, '245');
		}
...
elseif ($act == 'add_edit_address'){
	...
	ecs_header("Location: buy.php?act=checkout&bak=$bak\n");
	/*
	if($result){
