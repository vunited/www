...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <th><?php echo $this->_var['lang']['goods_thumb']; ?></th><!-- 牛模式(http://niumos.com)修改 -->
	<th><a href="javascript:listTable.sort('commission_num'); "><?php echo $this->_var['lang']['commission_num']; ?></a><?php echo $this->_var['sort_commission_num']; ?></th><!-- 牛模式(http://niumos.com)修改 -->
	<th><a href="javascript:listTable.sort('shop_title'); "><?php echo $this->_var['lang']['shop_title']; ?></a><?php echo $this->_var['sort_shop_title']; ?></th><!-- 牛模式(http://niumos.com)修改 -->
    ...
    <th><a href="javascript:listTable.sort('is_taobao'); ">去淘宝</a><?php echo $this->_var['sort_is_taobao']; ?></th><!-- 牛模式(http://niumos.com)修改 -->
...
?>
  <tr>
    ...
    <td><a href="../goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank" title="<?php echo $this->_var['lang']['view']; ?>"><img src="<?php if (strpos ( $this->_var['goods']['goods_thumb'] , 'ttp' ) > 0): ?><?php echo $this->_var['goods']['original_img']; ?>_40x40.jpg<?php else: ?>../<?php echo $this->_var['goods']['goods_thumb']; ?><?php endif; ?>" width="40" height="40" border="0" /></td><!-- 牛模式(http://niumos.com)修改 -->
	<td align="center"><a style="<?php if ($this->_var['goods']['r_img']): ?>color:red;<?php endif; ?>" href="<?php if ($this->_var['goods']['commission_num'] == 100): ?>http://detail.1688.com/offer/<?php echo $this->_var['goods']['num_iid']; ?>.html<?php elseif ($this->_var['goods']['num_iid']): ?>https://item.taobao.com/item.htm?id=<?php echo $this->_var['goods']['num_iid']; ?><?php else: ?>../goods.php?id=<?php echo $this->_var['goods']['goods_id']; ?><?php endif; ?>" target="_blank"><?php if ($this->_var['goods']['commission_num'] == 100): ?>阿里<?php elseif ($this->_var['goods']['commission_num'] == 2 || $this->_var['goods']['commission_num'] == 5): ?>天猫<?php elseif ($this->_var['goods']['nick']): ?>淘宝<?php else: ?>本地<?php endif; ?></a></td><!-- 牛模式(http://niumos.com)修改 -->
    <td align="center"><?php echo $this->_var['goods']['shop_title']; ?></td><!-- 牛模式(http://niumos.com)修改 -->
    ...
    <td align="center"><img src="images/<?php if ($this->_var['goods']['is_taobao']): ?>yes<?php else: ?>no<?php endif; ?>.gif" onclick="listTable.toggle(this, 'toggle_taobao', <?php echo $this->_var['goods']['goods_id']; ?>)" /></td><!-- 牛模式(http://niumos.com)修改 -->
...
?>
    ...
    <?php if ($this->_var['goods']['num_iid']): ?>
	  <a href="<?php if ($this->_var['goods']['commission_num'] == 100): ?>albbshops.php<?php else: ?>shops.php<?php endif; ?>?act=getRate&num_iid=<?php echo $this->_var['goods']['num_iid']; ?>&goods_id=<?php echo $this->_var['goods']['goods_id']; ?>" ><img src="https://img.alicdn.com/imgextra/i2/619666972/TB230jyppXXXXaCXXXXXXXXXXXX-619666972.png" width="23" height="16" border="0" /></a>
	  <?php endif; ?>
    </td>
  </tr>
  <?php endforeach; else: ?>
...
<!-- 牛模式(http://niumos.com)修改begin -->
	<option value="to_taobao">去淘宝</option>
	<option value="not_taobao">取消去淘宝</option>
	<option value="re_taobao">更新数据</option>
	<option value="img_local">图片本地化</option>
	<option value="translate">翻译</option>
	<option value="get_rate">采集评论</option>
<!-- 牛模式(http://niumos.com)修改end -->
  ...
  <input type="text" value="10" class="textinput" name="ratenum" style="display:none" size="8" ><!-- 牛模式(http://niumos.com)修改 -->
	<?php if ($this->_var['suppliers_list'] > 0): ?>
  <!--二级主菜单：转移供货商-->
