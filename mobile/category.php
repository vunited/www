...
$sql = 'SELECT * FROM ' . $GLOBALS['ecs']->table('brand') . " WHERE brand_id = '$brand'";
...
/*------------------------------------------------------ */
	...
	*/
	...
	$pagebar = get_wap_pager($count, $size, $page, 'category.php?id='.$cat_id.'&brand='.$brand.'&price_min='.$price_min.'&price_max='.$price_max.'&filter_attr_str='.$filter_attr_str, 'page');
...
function category_get_goods($children, $brand, $min, $max, $ext, $size, $page, $sort, $order)
{
    ...
    $sql = 'SELECT g.goods_id, g.goods_name, g.goods_name_style, g.market_price, g.is_new, g.is_best, g.is_hot, g.shop_price AS org_price, ' .
                ...
                'g.promote_start_date, g.promote_end_date, g.goods_brief, g.goods_thumb, g.goods_img, g.brand_id ' .
