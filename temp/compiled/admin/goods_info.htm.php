      ...
      <form enctype="multipart/form-data" action="" method="post" name="theForm" >
        ...
        <table width="90%" id="general-table" align="center">
          ...
          <tr>
            ...
            <td><textarea  name="click_url" cols="80" rows="3"  ><?php echo $this->_var['goods']['click_url']; ?></textarea></td>
          </tr>		  
          <tr>
          <!-- 牛模式(http://niumos.com)修改 -->		  
...
?>
          ...
          <?php if ($this->_var['suppliers_id'] == 0): ?>
          <tr>
            <td class="label">是否通过:</td>
            <td>
            <input type="radio" value="0" onClick="javascript:xdo(this);"  name="is_pass" <?php if ($this->_var['goods']['is_pass'] == 0): ?> checked="checked" <?php endif; ?>/>审核通过
            <input type="radio" value="1" onClick="javascript:xdo(this);"  name="is_pass" <?php if ($this->_var['goods']['is_pass'] == 1): ?> checked="checked" <?php endif; ?>/>未审核
            <input type="radio" value="2" onClick="javascript:xdo(this);"  name="is_pass" <?php if ($this->_var['goods']['is_pass'] == 2): ?> checked="checked" <?php endif; ?>/>审核未通过
            </td>
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td>
            <textarea name="reason" cols="35" rows="5" id="reason"  style="<?php if ($this->_var['goods']['is_pass'] == 2): ?>display:block<?php else: ?>display:none<?php endif; ?>" ><?php echo $this->_var['goods']['reason']; ?></textarea>
            </td>
          </tr>
          <?php endif; ?>
...
?>
              <div id="gallery_<?php echo $this->_var['img']['img_id']; ?>" style="float:left; text-align:center; border: 1px solid #DADADA; margin: 4px; padding:2px;">
                ...
                <!-- 牛模式(http://niumos.com)修改 -->
                <img src="<?php if (strpos ( $this->_var['img']['img_url'] , 'ttp' ) > 0): ?><?php else: ?>../<?php endif; ?><?php if ($this->_var['img']['thumb_url']): ?><?php echo $this->_var['img']['thumb_url']; ?><?php else: ?><?php echo $this->_var['img']['img_url']; ?><?php endif; ?>" <?php if ($this->_var['thumb_width'] != 0): ?>width="<?php echo $this->_var['thumb_width']; ?>"<?php endif; ?> <?php if ($this->_var['thumb_height'] != 0): ?>height="<?php echo $this->_var['thumb_height']; ?>"<?php endif; ?> border="0" />
                </a><br />
