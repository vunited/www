...
$_LANG['virualcard']   	= '虚拟卡'; //虚拟商品列表
$_LANG['shiparea_manage']   	= '配送区域管理'; //虚拟商品列表
$_LANG['invoice_manage'] 	= '发票管理';
$_LANG['feedback_priv'] 	= '发送/查看留言';
