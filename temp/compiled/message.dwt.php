...
<div style="background: url(themes/default/images/index65.jpg) top center no-repeat; padding-top:115px; height:575px">
    <div class="container">
      <div class="ts">
         <div class="p1"><?php echo $this->_var['message']['content']; ?></div>        
...
?>
          <p><a href="<?php echo $this->_var['url']; ?>" class="back"><?php echo $this->_var['info']; ?></a></p>
