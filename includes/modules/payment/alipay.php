...
if($info)
{
	class alipay
	{
		...
		function get_code($order, $payment)
		{
			...
			//$button = '<input type="button" onclick="window.open(\''.$gateway.$param. '&sign='.md5($sign).'\')" value="' .$GLOBALS['_LANG']['pay_button']. '" />';			
			$button = '<span onclick="window.open(\''.$gateway.$param. '&sign='.md5($sign).'\')">' .$GLOBALS['_LANG']['pay_button']. '</span>';
	...
	class alipay
	{
		...
		function get_code($order, $payment)
		{
			...
			$button = '<input type="button" onclick="window.open(\'https://mapi.alipay.com/gateway.do?'.$param. '&sign='.md5($sign).'&sign_type=MD5\')" value="' .$GLOBALS['_LANG']['pay_button']. '" />';
