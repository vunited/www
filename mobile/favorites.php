...
function get_m_collection_goods($user_id, $num = 10, $start = 0){
	$sql = 'SELECT g.goods_thumb, g.goods_id, g.goods_name, g.market_price, g.is_new, g.is_best, g.is_hot, g.shop_price AS org_price, '.
				"IFNULL(mp.user_price, g.shop_price * '$_SESSION[discount]') AS shop_price, ".
				'g.promote_price, g.promote_start_date,g.promote_end_date, g.brand_id , c.rec_id, c.is_attention' .
